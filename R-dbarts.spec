...
Version  : 0.9.12
Release  : 29
URL      : https://cran.r-project.org/src/contrib/Archive/dbarts/dbarts_0.9-12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Archive/dbarts/dbarts_0.9-12.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564079540
