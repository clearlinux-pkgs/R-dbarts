...
Version  : 0.9.4
Release  : 14
URL      : https://cran.r-project.org/src/contrib/dbarts_0.9-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dbarts_0.9-4.tar.gz
Summary  : Discrete Bayesian Additive Regression Trees Sampler
Group    : Development/Tools
License  : GPL-2.0+
Requires: R-dbarts-lib
...
export LANG=C
export SOURCE_DATE_EPOCH=1530658169
